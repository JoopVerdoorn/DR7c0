	...
	function onUpdate(dc) {
	   ...
	   //! Display demo screen
		...
		if (umyNumber == mtest) {
      		...
      		dc.drawText(120, 70, Graphics.FONT_XTINY, "Version 1.04", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
			...
			dc.drawText(120, 215, Graphics.FONT_XTINY, "Version 1.04", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
      	}
	   }
